...
<div class="fondo-login">
    <div class="icon">
        <a href="/howest/index.php">
            <i class="fa-solid fa-shield-dog dog-icon"></i>
        </a>
    </div>
    <div class="titulo">
        Inicia sesion en Howest
    </div>
    ...
    <div class="login col-3 mt-3">
        Nuevo en Howest? <a href="signup.php" style="text-decoration: none;">Crear Cuenta</a>
    </div>
</div>

<?php
    require_once("/Applications/XAMPP/xamppfiles/htdocs/howest/view/head/footer.php");
?>